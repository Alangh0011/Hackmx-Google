  ...
  return (
    <section id='contact' data-aos='fade-up' data-aos-delay='400'>
        <div className='py-8 lg:py-16 mx-auto max-w-screen-md'>
            <h2 className='mb-4 text-4xl tracking-tight font-extrabold text-center text-white'>Dudas? ¡Contactanos!</h2>
            <form action='#' className='space-y-8'>
                ...
                <div className='sm:col-span-2'>
                    <label for='message' className='block mb-2 text-xl font-medium text-white'>Mensaje</label>
                    <textarea 
                    rows="6"
                    id='message' 
                    className='shadow-sm bg-gray-300 font-bold border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5' 
                    placeholder='Deja un comentario aqui ...' required/>
                </div>
